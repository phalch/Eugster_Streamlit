...
# Si le script a changé → incrément automatique MINOR
...
lg0     = round((TZ1EP-(0/100)*Tnetz)*tt,2)      # vZEV oder vEVG
...
def compute_projection(
    ...
    #LEG Standard
    # pro kWh
    DELI = tbet  + (PK - PVrealisierung) *G2_10 /(G1_10 + G2_10) /ULEG_10
    DELV = G2_10 /ULEG_10
    DELZ = Zins_PV+Zins_K
    DELS = Steuer_LEG
    #Gewinn Total
